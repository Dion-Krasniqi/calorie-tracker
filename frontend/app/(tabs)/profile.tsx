  ...
  return (
    <View className='flex-1 bg-primary'>
      ...
      <View className='size-full justify-top items-center mt-20'>
        ...
        {ProfileInfo && <Text className='text-white'>Logged in as {ProfileInfo.username}</Text>}
        {/*{ ProfileInfo.expenditure > 0 ? (<Text>{ProfileInfo.expenditure}</Text>):
                                        (<Text className='text-white mt-20'>No Expenditure Value Entered</Text>)}
            */}
