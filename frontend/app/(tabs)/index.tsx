...
import { fetchFoods, fetchLogs, login } from "@/services/api";
...
export default function Index() {
  ...
  const {data: foods, loading: foodsLoading, error: foodsError, refetch, reset} = useFetch(() => fetchFoods({ query:  '' }), false);
  const {data: logsFood, loading:logsLoading, error:logsError} = useFetch(() =>fetchLogs(), false);
